...
function N1function() {
    ...
    if (novena1Day == '9/13/2024'){
      Novena1A.innerHTML = 'Day 8';
    }
    else if (novena1Day == '9/14/2024'){
  ...
  function N2function() {
    ...
    if (novena2Day == '9/12/2024'){
      Novena2A.innerHTML = 'Day 6';
    }
    else if (novena2Day == '9/13/2024'){
      Novena2A.innerHTML = 'Day 7';
    }
    else if (novena2Day == '9/14/2024'){
      Novena2A.innerHTML = 'Day 8';
    }
    else if (novena2Day == '9/15/2024'){
  ...
  function N3function() {
    ...
    if (novena3Day == '9/13/2024'){
      Novena3A.innerHTML = 'Day 8';
    }
    else if (novena3Day == '9/14/2024'){
